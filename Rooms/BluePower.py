...
dimLightScale1 = pygame.transform.scale(Assets.squishedDimTiles[2], (Assets.squishedDimTiles[2].get_width()/2, Assets.squishedDimTiles[2].get_height()*1.5))
dimLightScale2 = pygame.transform.scale(Assets.squishedDimTiles[2], (Assets.squishedDimTiles[2].get_width()/2.2, Assets.squishedDimTiles[2].get_height()*1.5))
dimLightScale3 = pygame.transform.scale(Assets.squishedDimTiles[2], (Assets.squishedDimTiles[2].get_width()/2.5, Assets.squishedDimTiles[2].get_height()*1.5))

LightScale1 = pygame.transform.scale(Assets.squishedTiles[2], (Assets.squishedTiles[2].get_width()/2, Assets.squishedTiles[2].get_height()*1.5))
LightScale2 = pygame.transform.scale(Assets.squishedTiles[2], (Assets.squishedTiles[2].get_width()/2.2, Assets.squishedTiles[2].get_height()*1.5))
LightScale3 = pygame.transform.scale(Assets.squishedTiles[2], (Assets.squishedTiles[2].get_width()/2.5, Assets.squishedTiles[2].get_height()*1.5))
...
def Room(screen, screen_res, events):
    ...
    if bluePower:
        ...
        lightsNew.append(LightSource(lights[(pulse - 1) % 8][0].x + 20, lights[(pulse - 1) % 8][0].y + 15, radius=50, strength=100, color=(0, 162, 232)))
