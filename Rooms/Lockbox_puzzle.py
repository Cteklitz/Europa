...
background = pygame.image.load("Assets/TableLockbox.png")
background2 = pygame.image.load("Assets/OpenLockBox.png")
                    ...
                    for number in numbers:
                        if number.rect.collidepoint(mouse_pos):
                            ...
                            if number.state == 9:
                                ...
                                number.state += 1
                            # Check for 4-digit combination: 2,1,4,3
                            if (numbers[0].state == 2 and numbers[1].state == 1 and 
                                numbers[2].state == 4 and numbers[3].state == 3):
                                if not played:
                                    played = True
                                    Sounds.letter.play()
                                solved = True
