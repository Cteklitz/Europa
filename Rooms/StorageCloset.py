...
def inBounds(x, y):
    doorRect = pygame.Rect(300,108,door.get_width(),door.get_height())
...
def positionDeterminer(cameFrom):
    global player_pos
    player_pos = pygame.Vector2(300 - 20 + door.get_width()/4, 108 + (door.get_height()*5/6))
...
def Room(screen, screen_res, events):
    ...
    virtual_screen.blit(floor, (0, 156))
    pygame.draw.line(virtual_screen, (0,0,0), (64, 0), (64, 156), 1)
    pygame.draw.line(virtual_screen, (0,0,0), (288, 0), (288, 156), 1)

    if power and level == 2:
        virtual_screen.blit(Assets.tiles[2], (64,0))
        virtual_screen.blit(Assets.tiles[2], (256,0))
        virtual_screen.blit(Assets.tiles[2], (64,124))
        virtual_screen.blit(Assets.tiles[2], (256,124))
    else:
        virtual_screen.blit(Assets.dimTiles[2], (64,0))
        virtual_screen.blit(Assets.dimTiles[2], (256,0))
        virtual_screen.blit(Assets.dimTiles[2], (64,124))
        virtual_screen.blit(Assets.dimTiles[2], (256,124))

    virtual_screen.blit(door, (300,108))
